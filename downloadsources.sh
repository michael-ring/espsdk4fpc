...
[ ! -f xtensa-esp32-elf-gcc8_4_0-esp-2020r3-linux64-amd64.tar.gz ] && curl -L https://dl.espressif.com/dl/xtensa-esp32-elf-gcc8_4_0-esp-2020r3-linux64-amd64.tar.gz --output xtensa-esp32-elf-gcc8_4_0-esp-2020r3-linux64-amd64.tar.gz
